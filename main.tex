...
\definecolor{ocre}{RGB}{52, 201, 57} % Define the orange color used for highlighting throughout the book
\definecolor{bashcodebg1}{HTML}{e7f5f8}
...
\definecolor{bashcodebg}{HTML}{E8F9E7}
\definecolor{bashcodebg2}{HTML}{1BC34D}
\definecolor{bashcodebg3}{HTML}{029F31}
...
\definecolor{bleu_cite}{RGB}{50, 168, 82}
...
% PDF metadata
\hypersetup{
pdftitle={COAWST configuration guide - Third Edition},
