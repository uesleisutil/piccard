...
\section{CCompiling the Sandy test case}
\bigskip
...
\begin{tcolorbox}[enhanced,
  ...
  overlay={\begin{tcbclipinterior}\fill[red!75!blue!50!white] (frame.south west)
    rectangle node[text=white,font=\sffamily\bfseries\footnotesize,rotate=0] {WARNING} ([xshift=18mm]frame.north west);\end{tcbclipinterior}}]
 The command \textit{qsub} will submit you job. It will send the executed script to a batch of the cluster, reserving a part of the processors for its simulation.
\end{tcolorbox}
\bigskip
